...
import com.example.myapplication.databinding.ActivityDatePickerDialogBinding;

public class DatePickerDialog extends AppCompatActivity {

    private ActivityDatePickerDialogBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
         binding = ActivityDatePickerDialogBinding.inflate(getLayoutInflater());
